Shader "Unlit/ClickWaveShader"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {} // 主纹理
        _ColorLeft ("ColorLeft", Color) = (0,1,0,1) // 按钮左侧颜色
        _ColorRight ("ColorRight", Color) = (0,0,1,1) // 按钮右侧颜色
        _Radius ("Radius", Float) = 1 // 圆环半径
        _RadiusThickness ("RadiusThickness", Float) = 1 // 圆环厚度
        _WaveAlpha ("WaveAlpha", Range(0, 1)) = 0.5 // 波纹透明度
        [HDR] _WaveColor ("WaveColor", Color) = (1,1,1,1) // 波纹颜色
        [hideInInspector] _CircleScaleOffset ("CircleScaleOffset", Float) = 1 // Width / Height ，圆环缩放比例
        [hideInInspector] _MouseUVPos ("MouseUVPos", Vector) = (0,0,0,0) // 鼠标UV坐标
    }
    SubShader
    {
        // Use the Unlit shader model
